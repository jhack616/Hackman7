...
function loadPoints(points,texture) {
    ...
    //left wall
    points.push(vec4(-6.0, 0 , 10, 1)); //bottom left
    texture.push(vec2(0,0));
    points.push(vec4(-6.0 , 4 , 10, 1)); //top left
    texture.push(vec2(0,.5));
    points.push(vec4(-6.0 , 4 , 0, 1)); //top right
    texture.push(vec2(.5, .5));
    ...
    points.push(vec4(-6.0 , 4 , 0, 1)); //top right
    texture.push(vec2(.5, .5));
    points.push(vec4(-6.0 , 0 , 0, 1)); //bottom right
    texture.push(vec2(.5, 0));

    //back wall
    points.push(vec4(-6.0 , 0 , 0, 1)); //bottom left
    texture.push(vec2(0,0));
    points.push(vec4(-6.0 , 4 , 0, 1)); //top left
    texture.push(vec2(0,.5));
    points.push(vec4(6.0 , 4 , 0, 1)); //top right
    texture.push(vec2(.5, .5));
    ...
    points.push(vec4(6.0 , 4 , 0, 1)); //top left
    texture.push(vec2(0,.5));
    points.push(vec4(6.0 , 4 , 10, 1)); //top right
    texture.push(vec2(.5, .5));
    ...
    points.push(vec4(6.0 , 4 , 10, 1)); //top right
    texture.push(vec2(.5, .5));
    points.push(vec4(6.0 , 0 , 10, 1)); //bottom right
    texture.push(vec2(.5, 0));

    //left art
    points.push(vec4(-5.9999, .5 , 6, 1)); //bottom left
    texture.push(vec2(.5,.5));
    points.push(vec4(-5.9999, 3.5 , 6, 1)); //top left
    texture.push(vec2(.5,1));
    points.push(vec4(-5.9999, 3.5 , 2, 1)); //top right
    ...
    points.push(vec4(-5.9999, 3.5 , 2, 1)); //top right
    texture.push(vec2(1, 1));
    points.push(vec4(-5.9999, .5 , 2, 1)); //bottom right
    texture.push(vec2(1, .5));

    //center art
    points.push(vec4(-2,.5,.0001, 1)); //bottom left
    texture.push(vec2(.5,0));
    points.push(vec4(-2,3.5,.0001, 1)); //top left
    texture.push(vec2(.5,.5));
    points.push(vec4(2,3.5,.0001, 1)); //top right
    texture.push(vec2(1,.5));
    ...
    points.push(vec4(2, 3.5 , .0001, 1)); //top right
    texture.push(vec2(1,.5));
    points.push(vec4(2, .5 , .0001, 1)); //bottom right
...
onload = function init()  {
    ...
    // Allow use of menu elements for anti-aliasing techniques
